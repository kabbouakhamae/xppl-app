        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <div class="breadcrumb-header justify-content-between align-items-center mb-2 mt-0" >
                        ...
                        <div class="d-flex my-xl-auto right-content align-items-center">
                            <div class="pos-relative wd-xl-200 wd-lg-200 wd-md-200 wd-100p">
                                <input class="form-control pd-l-30" type="text" placeholder="Search equip no..." v-model="search" @input="searchChange()" >
                    ...
                    <div class="table-responsive border mt-3" style="max-height: 300px">
                        <table class="table main-table-reference text-nowrap mb-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">  
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Code..." v-model="genCodeForm.code">
                    </div>   
                    <div class="form-group">
                        <label class="mb-0">Description</label>
                        <input type="text" class="form-control" placeholder="Description..." v-model="genCodeForm.descr">
                    </div>   
                    <div class="form-group">
                        <label class="mb-0">Used  <span class=" text-danger">*</span></label>
                        <input type="number" class="form-control" placeholder="Used..." v-model="genCodeForm.used">
                    </div>   
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">  
                    ...
                    <div class="form-group">
                        <label class="mb-0">Code  <span class=" text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Code..." v-model="fuelCodeForm.code">
                    </div>   
                    <div class="form-group">
                        <label class="mb-0">Description</label>
                        <input type="text" class="form-control" placeholder="Description..." v-model="fuelCodeForm.descr">
                    </div>   
                    <div class="form-group">
                        <label class="mb-0">Used  <span class=" text-danger">*</span></label>
                        <input type="number" class="form-control" placeholder="Used..." v-model="fuelCodeForm.used">
                    </div>   
                    <div class="d-flex justify-content-end">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">    
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Reserve no..." v-model="workOrderForm.reserve_no">
                    </div>    
                    <div class="form-group">
                        <label class="mb-0">Basic Date  <span class=" text-danger">*</span></label>
                        <input type="date" class="form-control" placeholder="Date..." v-model="workOrderForm.basic_date" @change="dateChanged()">
                    </div>    
                    <div class="d-flex justify-content-end">
...
export default {
    ...
    data() {
        return {
            ...
            equipData: [],
            workOrderData: [],
            genCodeForm: {id: '', category: '', code: '', descr: '', used: '1'},
