                                ...
                                <tr class="tr-hover" v-for="lst in codeList" :key="lst.id">
                                    ...
                                    <td class="p-0 align-middle border-end-0">
                                        <div class="d-flex justify-content-start ms-1">
                                            <button class="btn btn-icon btn-sm btn-i wd-25 ht-25" title="Edit" @click="editCode(lst.id)">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-2">  
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Code..." v-model="codeForm.code">
                        </div>   
                        <div class="form-group">
                            <label class="mb-0">Description</label>
                            <input type="text" class="form-control" placeholder="Description..." v-model="codeForm.descr">
                        </div>   
                        <div class="form-group">
                        ...
                        <table class="table main-table-reference text-nowrap mg-b-0">
                            ...
                            <tbody>
                                <tr class="tr-hover cur-pointer" v-for="(lst, key) in equipList" :key="lst.id" @click="selectedEquip(key, lst.equip_no)" :style="key === equipRowSel ? 'background-color: #dadee7; color: blue' : ''">
                                    ...
                                    <td class="p-0 align-middle border-end-0">
                                        <div class="d-flex justify-content-start ms-1">
                                            <button class="btn btn-icon btn-sm btn-i wd-25 ht-25" title="Edit" @click="editEquip(lst.id)">
                                                <i class="bx bx-edit text-info" style="font-size: 16px"></i>
                                            </button> 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-2">  
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Number..." v-model="equipForm.equip_no">
                        </div>   
                        <div class="form-group">
                            <label class="mb-0">Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" placeholder="Name..." v-model="equipForm.equip_name">
                        </div>   
                        <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-2">  
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="Date..." v-model="workOrderForm.basic_date">
                        </div>   
                        <div class="d-flex justify-content-end">
